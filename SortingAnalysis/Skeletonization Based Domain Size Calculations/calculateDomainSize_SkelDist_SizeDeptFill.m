function [domainWidthinMicrons_RepByPixel_Mean, domainWidthinMicrons_RepByPixel_STD, ...
    domainWidthinMicrons_RepByPixel_SE, domainWidthinMicrons_RepByPixel_Skew, domainWidthinMicrons_RepByPixel_Kurtosis] = ...
        calculateDomainSize_SkelDist_SizeDeptFill(cellType_onGrid_OverTime, cellDiameterInUM, micronsPerPixel_X_Original, micronsPerPixel_X_Target, cellTypeID, doPlot)
...
% domain size mean and variance over time
